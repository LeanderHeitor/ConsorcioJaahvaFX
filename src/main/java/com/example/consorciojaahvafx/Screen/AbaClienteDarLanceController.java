...
public class AbaClienteDarLanceController {
    ...
    @FXML
    private TextField tfValorLance;

    @FXML
    private Button btFinalizarLance;
    ...
    private void finalizarSimulacao() {
        try {
            double valorSimulado = Double.parseDouble(tfValorLance.getText());
